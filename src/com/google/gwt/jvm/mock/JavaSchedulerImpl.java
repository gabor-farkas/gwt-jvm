 ...
 * fakes time
 */
public class JavaSchedulerImpl extends SchedulerImpl {
  ...
  @Override
  public void scheduleFixedDelay(final RepeatingCommand cmd,
      final int delayMs) {
    new Timer() {
      @Override
      public void run() {
  ...
  @Override
  public void scheduleFixedPeriod(final RepeatingCommand cmd,
      int delayMs) {
    new Timer() {
      @Override
      public void run() {
  ...
  public static JavaSchedulerImpl get() {
    Scheduler scheduler = Scheduler.get();
    if (scheduler instanceof JavaSchedulerImpl) {
      return (JavaSchedulerImpl) scheduler;
    } else {
      throw new RuntimeException("Scheduler not an instance of JavaSchedulerImpl." +
          "Did you correctly set up the GwtBrowserEmulator mocks?");
    }
  }
}
